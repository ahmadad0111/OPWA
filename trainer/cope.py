...
from models.EEG_model import EEGNet1D
...
import copy
import random
from prototypical.prototypical_cope import PrototypicalLoss


class CopeTrainer(object):
        ...
        for subject_id in range(self.args.start_range, self.args.subject_range):
            ...
            for episode in range(1, self.args.max_episode + 1):
                ...
                for i, batch in enumerate(tqdm_gen, 1):
                    ...
                    embeddings = self.model(data_comb)
